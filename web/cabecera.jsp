<head>
    ...
    <meta name="description" content="Responsive sidebar template with sliding effect and dropdown menu based on bootstrap 4.3.1">
        
    <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/img/tesa.ico" sizes="32x32"/>
    <title>Tickets TESA</title>
    <script src="${pageContext.request.contextPath}/assets/js/jquery.min.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/assets/js/popper.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/jquery-3.3.1.slim.min.js" type="text/javascript"></script>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/select2.min.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/open-iconic-bootstrap.css" rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/assets/css/my-login.css" rel="stylesheet"/>
