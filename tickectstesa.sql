CREATE DATABASE  IF NOT EXISTS `ticketstesa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `ticketstesa`;
...
INSERT INTO `binnacle` VALUES (1,'DVT19945','Bitacora','2019-04-06 20:52:50'),(2,'DVT19945','klshdvyurhteaid','2019-04-06 20:53:40');
...
INSERT INTO `cases` VALUES ('DST19238',1,7,3,'2019-04-14 08:19:42','Descripción',0.00,NULL,'2019-04-06 20:19:50',NULL,NULL),('DVT19945',2,13,2,'2019-04-27 08:51:36','Caso aceptado',100.00,NULL,'2019-04-06 20:51:48','2019-04-06 20:53:40',NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_individual_request`(in id int, in created_by int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_individual_user`(
    ID int)
BEGIN
